...
def seed_default_role_permissions() -> None:
    ...
    try:
        role_permission_map = {
            ...
            "FARMER": ["AUTH_LOGIN", "BATCH_CREATE", "BATCH_VIEW_OWN", "BATCH_UPDATE_OWN", "BATCH_DELETE_OWN", "SAMPLE_CREATE", "SAMPLE_VIEW_OWN", "QR_GENERATE"],
            "AUDITOR": ["AUTH_LOGIN", "BATCH_VIEW_ALL", "SAMPLE_VIEW_ALL", "AUDIT_VIEW", "AUDIT_UPLOAD_REPORT", "AUDIT_APPROVE", "AUDIT_REJECT", "AUDIT_VIEW_HISTORY"],
